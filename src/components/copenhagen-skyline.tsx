...
const LAYERS = [
  { height: 110, fill: "#7c3aed", opacity: 0.08, duration: "150s" },
  { height: 150, fill: "#a855f7", opacity: 0.11, duration: "104s" },
  { height: 188, fill: "#22d3ee", opacity: 0.13, duration: "72s" },
];
...
export function CopenhagenSkyline() {
  return (
    <div
      aria-hidden
      className="pointer-events-none absolute inset-x-0 bottom-0 z-0 h-[220px] overflow-hidden [mask-image:linear-gradient(to_top,black,transparent)]"
    >
      {LAYERS.map((layer) => (
        <div
          key={layer.fill}
