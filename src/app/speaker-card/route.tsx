...
// A 1080x1350 "I'm speaking at" card for a speaker to post themselves.
//  - GET  ?name=&topic=&title=&photo=  (photo = /public path or https URL)
//  - POST { name, topic, title, photo } (photo can also be a data: URL)
// A name is required; without one there is 400 and no image, since a card
// with nobody on it is not worth shipping.
